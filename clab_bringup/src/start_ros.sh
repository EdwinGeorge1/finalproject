...
usr/bin/tmux send-keys -t brave.0 "brave-browser --kiosk http://localhost/clab/bootup.php" ENTER
...
# sleep 8
# usr/bin/tmux -2 new-session -d -s clab_py
# usr/bin/tmux send-keys -t clab_py.0 "rosrun clab_bringup clab.py" ENTER
