      ...
      <div class="container">
         <div class="col-md-10 col-md-offset-1">
            <div class="fab-lab-supports">
               ...
               <h3><i class="fa fa-dot-circle-o" aria-hidden="true"></i><a class="" href="#" style="text-decoration:none">ELECTRICAL & ELECTRONICS SUPPORT</a></h3>
               
                 <div class="row">
                  <div class="col-md-4 col-sm-4 col-xs-12">
                     <a class="" href="#" onclick="buttonClick('ele-support-page', 'chandan-button');">
                        <div >
               ...
               <div class="back-section">
                  <a class="btn back-btn" href="fab-lab-support.php" onclick="buttonClick('electrical-support-page', 'ele-back-button');">
