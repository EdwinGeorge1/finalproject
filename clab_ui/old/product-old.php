<?php
$imgArr = [
   [ 'title'=>"SPIRE STONE", 'desc'=>"Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s", 'img'=>"image-1.png" ],
   [ 'title'=>"BELKIN WEMO SWITCH", 'desc'=>"Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.", 'img'=>"image-2.png" ],
   [ 'title'=>"DROP STOP", 'desc'=>"Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s", 'img'=>"image-3.png" ],
   [ 'title'=>"GROHE SENSE", 'desc'=>"Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s", 'img'=>"image-4.png" ],
   [ 'title'=>"LIVE SCRIBE SMART PEN", 'desc'=>"Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s", 'img'=>"image-5.png" ],
   [ 'title'=>"MINI PROJECTOR", 'desc'=>"Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s", 'img'=>"image-6.png" ],
   [ 'title'=>"ROLLR MINI", 'desc'=>"Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s", 'img'=>"image-7.png" ],
   [ 'title'=>"VIRTUAL KEYBOARD", 'desc'=>"Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s", 'img'=>"image-8.png" ],
      ...
      <div class="container">
         ...
         <div class="col-md-10 col-md-offset-1">            
            ...
            <div class="back-to-home">
               <a class="" href="start-01.php">Home</a>
               <!-- <a href="start-01.php" class="badge badge-light">Light</a> -->
            </div>
         </div>
      </div>
      <!-- / banner section end -->
